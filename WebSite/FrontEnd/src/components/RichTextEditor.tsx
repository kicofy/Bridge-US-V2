  ...
  return (
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <div
          ref={editorRef}
          className="min-h-[200px] sm:min-h-[300px] rounded-xl border bg-background p-3 sm:p-4 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[var(--bridge-blue)] whitespace-pre-wrap break-words"
          contentEditable
